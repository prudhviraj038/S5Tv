...
public class MainCategory implements Serializable {
   ...
   ArrayList<Chanel>  chanels;
    ...
    MainCategory(JSONObject jsonObject){
        image="http://clients.outlinedesigns.in/s5tv/uploads/gallery/6Zj7A13.png";
        title="";
        title_te="";
        try {
...
//            JSONObject jsonObject2 =jsonObject.getJSONObject("chanel");
            ...
            for(int i=0;i<jsonArray.length();i++) {
                chanels.add(new Chanel(jsonArray.getJSONObject(i)));
            }
